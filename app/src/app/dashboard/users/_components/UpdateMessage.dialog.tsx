...
import { IconClock, IconClock12, IconClockCog, IconTimeDuration15 } from "@tabler/icons-react";
	...
	return (
		<Dialog open={open} onOpenChange={setOpen}>
			...
			<DialogContent className="sm:max-w-[525px] max-h-[90dvh] overflow-auto text-gray-800">
                ...
                <div className="py-2">
                    <div className="flex items-center gap-2 mb-5 text-[#9E9E9E]">
                        <IconClock color="#1691B2" />
                        Scheduled
                    </div>
                    <form onSubmit={onSubmit} className="grid gap-6gap-x-5 text-[#424242]">
